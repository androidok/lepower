...
public class SingleActivity extends Activity implements ReplayCallback,
	...
	public void setData() {
		...
		// 设置说说内容
		contentText.setText(friend.contentText);
...
//		System.out.println("TAG : post" + friend /*friend.friendId*/);
		...
		// 发送评论到服务器
		FriendActionTool.sendReply2Server(TAG, reply,SINGLE_REPLY_BACK,this,null);
	}
...
//			showDiscuss();
	...
	public void transmitFriend() {
		...
		//添加到后台服务器
		FriendActionTool.transmitFriend(TAG, friend.friendId, 
	...
	private void delParise(){
		int location=FriendActionTool.getPositionFavours(
				friend.favourList, user.getUserId());
		if(location!=-1){
