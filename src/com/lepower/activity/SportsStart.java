...
public class SportsStart extends Activity {
	...
	private int[] imageViewIdArray = { R.id.ivCancel, R.id.ivWalk,
			...
			R.id.ivSitUp };
	// 各项运动是对应的应用包名 数组
	private String[] packageNameArray = { "", "com.flyerqiu.pedometer",
			"com.flyeqwerpedometer", "com.flyerqiu.pedometer",
			"com.flyerqiu.pedometer", "com.flyerqiu.pedometer",
			"com.flyerqiu.pedometer" };
