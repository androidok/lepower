...
public class ScoreMainActivity extends Activity {
	...
	//所在位置城市信息，天气和气温
	private TextView tvNowAddress,tvTemp,tvLeID,tvNickName;
	private ImageView ivWeatherBg;
	
//	private String mcode="10:2B:ED:B0:A9:2A:1C:AD:84:E3:2B:15:C3:FF:A0:AD:A7:48:E4:45"+";"+"com.seu.lepower";
//	private String BAIDU_MAP_APPKEY="xYAefXbfoAnWGms7IL4GlGVG";
...
//		rivHead.setImageResource(R.drawable.atype_bicycling);//测试
		//初始化View
		initView();
		
		//初始化顶部信息（包括所在地城市信息，天气和气温信息）
		////网络可用即可获取地址信息//获取地址信息
		if(InternetState.isNetWorkConnected(this)){
			getLocation();
		}else{
			Toast.makeText(this, "网络不可用，请检查网络连接", 0);
		}
//		if(mLocation!=null){
//			//地址对象存在就获取天气信息
...
//		if(userNow==null)
		url = userNow.getImgURL();
		
		//设置ID和昵称,id先保存起来
		userIDNow=userNow.getUserId();
//		tvLeID.setText(userIDNow);
		userNow.getNickName();
		tvNickName.setText(userNow.getNickName());
		
		Log.d("heheda", userIDNow+"和"+userNow.getNickName());
		//获取头像信息，并设置
		...
		.setIgnoreGif(false)
		.build();
		x.image().bind(rivHead, url, imageOptions);
...
//				sportRecordList
				...
				for(SportRecord sr : sportRecordList){
					if(sr.getType().equals("run")){
						TextView tvTitle=(TextView) smlivRunning.findViewById(R.id.tvTitle);
						TextView tvItem0Value=(TextView) smlivRunning.findViewById(R.id.tvItem0Value);
						TextView tvItem1Value=(TextView) smlivRunning.findViewById(R.id.tvItem1Value);
						TextView tvItem2Value=(TextView) smlivRunning.findViewById(R.id.tvItem2Value);
						TextView tvItem3Value=(TextView) smlivRunning.findViewById(R.id.tvItem3Value);
						TextView tvItem4=(TextView) smlivRunning.findViewById(R.id.tvItem4);
						TextView tvItem4Value=(TextView) smlivRunning.findViewById(R.id.tvItem4Value);
						tvTitle.setText("跑步记录");//标题设置
						tvItem0Value.setText(sr.getSportCount()+"次");//总次数
						tvItem1Value.setText(sr.getSportDis()+"m");//总距离
						tvItem2Value.setText(sr.getSportTime()+"h");//总时间
						tvItem3Value.setText(sr.getSportCal()+"kCal");//总卡路里
						tvItem4.setText("本月跑量");
						tvItem4Value.setText("");
					}else if(sr.getType().equals("walk")){
						TextView tvTitle=(TextView) smlivWalk.findViewById(R.id.tvTitle);
						TextView tvItem0Value=(TextView) smlivWalk.findViewById(R.id.tvItem0Value);
						TextView tvItem1Value=(TextView) smlivWalk.findViewById(R.id.tvItem1Value);
						TextView tvItem2Value=(TextView) smlivWalk.findViewById(R.id.tvItem2Value);
						TextView tvItem3Value=(TextView) smlivWalk.findViewById(R.id.tvItem3Value);
						TextView tvItem4=(TextView) smlivWalk.findViewById(R.id.tvItem4);
						TextView tvItem4Value=(TextView) smlivWalk.findViewById(R.id.tvItem4Value);
						tvTitle.setText("步行记录");//标题设置
						tvItem0Value.setText(sr.getSportCount()+"次");//总次数
						tvItem1Value.setText(sr.getSportDis()+"m");//总距离
						tvItem2Value.setText(sr.getSportTime()+"h");//总时间
						tvItem3Value.setText(sr.getSportCal()+"kCal");//总卡路里
						tvItem4.setText("总步数");
						tvItem4Value.setText(sr.getSportSteps()+"步数");
					}else if(sr.getType().equals("bike")){
						TextView tvTitle=(TextView) smlivBicyling.findViewById(R.id.tvTitle);
						TextView tvItem0Value=(TextView) smlivBicyling.findViewById(R.id.tvItem0Value);
						TextView tvItem1Value=(TextView) smlivBicyling.findViewById(R.id.tvItem1Value);
						TextView tvItem2Value=(TextView) smlivBicyling.findViewById(R.id.tvItem2Value);
						TextView tvItem3Value=(TextView) smlivBicyling.findViewById(R.id.tvItem3Value);
						TextView tvItem4=(TextView) smlivBicyling.findViewById(R.id.tvItem4);
						TextView tvItem4Value=(TextView) smlivBicyling.findViewById(R.id.tvItem4Value);
						tvTitle.setText("骑行记录");//标题设置
						tvItem0Value.setText(sr.getSportCount()+"次");//总次数
						tvItem1Value.setText(sr.getSportDis()+"m");//总距离
						tvItem2Value.setText(sr.getSportTime()+"h");//总时间
						tvItem3Value.setText(sr.getSportCal()+"kCal");//总卡路里
						tvItem4.setText("本月数据");
						tvItem4Value.setText("");
					}else if(sr.getType().equals("pushup")){
						TextView tvTitle=(TextView) smlivPushUp.findViewById(R.id.tvTitle);
						TextView tvItem0Value=(TextView) smlivPushUp.findViewById(R.id.tvItem0Value);
						TextView tvItem1=(TextView) smlivPushUp.findViewById(R.id.tvItem1);
						TextView tvItem1Value=(TextView) smlivPushUp.findViewById(R.id.tvItem1Value);
						TextView tvItem2Value=(TextView) smlivPushUp.findViewById(R.id.tvItem2Value);
						TextView tvItem3Value=(TextView) smlivPushUp.findViewById(R.id.tvItem3Value);
						TextView tvItem4=(TextView) smlivPushUp.findViewById(R.id.tvItem4);
						TextView tvItem4Value=(TextView) smlivPushUp.findViewById(R.id.tvItem4Value);
						tvTitle.setText("俯卧撑");//标题设置
						tvItem0Value.setText(sr.getSportCount()+"次");//总次数
						tvItem1Value.setText(sr.getSportNum()+"个");//总个数
						tvItem1.setText("总个数");
						tvItem2Value.setText("-");//总时间
						tvItem3Value.setText(sr.getSportCal()+"kCal");//总卡路里
						tvItem4.setText("本月数据");
						tvItem4Value.setText("");
					}else if(sr.getType().equals("jump")){
						TextView tvTitle=(TextView) smlivJumpRope.findViewById(R.id.tvTitle);
						TextView tvItem0Value=(TextView) smlivJumpRope.findViewById(R.id.tvItem0Value);
						TextView tvItem1=(TextView) smlivJumpRope.findViewById(R.id.tvItem1);
						TextView tvItem1Value=(TextView) smlivJumpRope.findViewById(R.id.tvItem1Value);
						TextView tvItem2Value=(TextView) smlivJumpRope.findViewById(R.id.tvItem2Value);
						TextView tvItem3Value=(TextView) smlivJumpRope.findViewById(R.id.tvItem3Value);
						TextView tvItem4=(TextView) smlivJumpRope.findViewById(R.id.tvItem4);
						TextView tvItem4Value=(TextView) smlivJumpRope.findViewById(R.id.tvItem4Value);
						tvTitle.setText("跳绳记录");//标题设置
						tvItem0Value.setText(sr.getSportCount()+"次");//总次数
						tvItem1Value.setText(sr.getSportNum()+"个");//总个数
						tvItem1.setText("总个数");
						...
						TextView tvTitle=(TextView) smlivSitUp.findViewById(R.id.tvTitle);
						TextView tvItem0Value=(TextView) smlivSitUp.findViewById(R.id.tvItem0Value);
						TextView tvItem1=(TextView) smlivSitUp.findViewById(R.id.tvItem1);
						TextView tvItem1Value=(TextView) smlivSitUp.findViewById(R.id.tvItem1Value);
						TextView tvItem2Value=(TextView) smlivSitUp.findViewById(R.id.tvItem2Value);
						TextView tvItem3Value=(TextView) smlivSitUp.findViewById(R.id.tvItem3Value);
						TextView tvItem4=(TextView) smlivSitUp.findViewById(R.id.tvItem4);
						TextView tvItem4Value=(TextView) smlivSitUp.findViewById(R.id.tvItem4Value);
						tvTitle.setText("仰卧起坐");//标题设置
						tvItem0Value.setText(sr.getSportCount()+"次");//总次数
						tvItem1Value.setText(sr.getSportNum()+"个");//总个数
						tvItem1.setText("总个数");
						tvItem2Value.setText("-");//总时间
