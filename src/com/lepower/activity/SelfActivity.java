...
public class SelfActivity extends Activity implements OnClickListener{
	...
	private ImageButton mIbSelfCenter;
	...
	private SettingItemView mSivSetting;
	...
	private void initView() {
		...
		mIbSelfCenter = (ImageButton)findViewById(R.id.enter_self_center);
		...
		mSivSetting = (SettingItemView)findViewById(R.id.siv_setting);
		...
		mSivSetting.setOnClickListener(this);
	}
	...
	public void onClick(View v) {
		...
		case R.id.siv_guanzhu: //进入我的关注列表
			...
			startActivity(intent);
			break;
		case R.id.siv_setting: //进入我的设置
			intent = new Intent(getActivity(), TabActivity5.class);
			startActivity(intent);
			break;
